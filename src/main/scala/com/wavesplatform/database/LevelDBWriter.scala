      ...
      for {
        ...
        for (txId <- rw.get(k.transactionIdsAtHeight(currentHeight))) {
          ...
          tx match {
            ...
            case _: PaymentTransaction | _: TransferTransaction | _: VersionedTransferTransaction | _: MassTransferTransaction |
                _: SignedMassTransferRequest => // balances already restored
